...
(function() {
    ...
    var DateTimeShortcuts = {
        ...
        addClock: function(inp) {
            ...
            document.querySelector("main .reserve_form").appendChild(clock_box);
        ...
        openClock: function(num) {
            ...
            clock_box.style.top = Math.max(0, findPosY(clock_link) - 1200) + 'px';
        ...
        addCalendar: function(inp) {
            ...
            document.querySelector("main .reserve_form").appendChild(cal_box);
        ...
        openCalendar: function(num) {
            ...
            cal_box.style.top = Math.max(0, findPosY(cal_link) -  1300) + 'px';
