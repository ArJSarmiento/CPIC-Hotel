    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reservation_date_time', models.DateTimeField(default=datetime.datetime(2021, 10, 31, 23, 49, 9, 525203))),
                ('expected_arrival_date_time', models.DateTimeField(default=datetime.datetime(2021, 10, 31, 23, 49, 9, 525203))),
                ('expected_departure_date_time', models.DateTimeField(default=datetime.datetime(2021, 10, 31, 23, 49, 9, 525203))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facility', models.ManyToManyField(to='hotelSystem.Facility')),
